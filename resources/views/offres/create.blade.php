                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('offres.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <textarea id="description" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="description" rows="6" required>{{ old('description') }}</textarea>
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="competences_requises" :value="__('Compétences requises (une par ligne)')" />
                            <textarea id="competences_requises" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" name="competences_requises" rows="4" required>{{ old('competences_requises') }}</textarea>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="niveau_experience_min" class="block mt-1 w-full" type="number" name="niveau_experience_min" :value="old('niveau_experience_min', 0)" min="0" required />
