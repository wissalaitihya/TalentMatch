...
Fournir une interface de chat conversationnel permettant aux agents RH de poser des questions sur les candidats analysés, avec des réponses basées sur les données réelles via des outils Laravel AI, et une mémoire de conversation persistante.
